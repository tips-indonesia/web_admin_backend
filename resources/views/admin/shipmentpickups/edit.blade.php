...
@section('content')
    ...
    <div class="row">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(300)->margin(0)->merge('public/images/logo.png',.25)->encoding('UTF-8')->errorCorrection('H')->generate($data->shipment_id)) !!} "> 
                    </div>
        ...
        var optionsqr = {
          ...
          radius: 0,
          image: 'https://image.freepik.com/free-icon/facebok-circular-logo_318-40188.jpg'
        }
        $('#qrcode').qrcode(optionsqr); 
