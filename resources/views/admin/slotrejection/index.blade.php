...
@endsection
@section('page_title')
<span class="text-semibold">Slot Rejection</span> - Show All
@endsection
@section('content')
<div class="panel panel-flat">
        {{ Form::open(array('url' => route('slotrejection.index'), 'method' => 'GET', 'id' => 'date_form')) }}
        ...
        <table class="table datatable-pagination">
            ...
            <tbody>
                @foreach ($datas as $data)
                    <tr>
                        <td>
                            <a href="{{ route('slotrejection.show', $data->id) }}">
                            {{ $data->slot_id }}
                            </a>
                        </td>
                        <td>
