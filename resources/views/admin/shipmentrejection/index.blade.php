...
@endsection
@section('page_title')
<span class="text-semibold">Shipment Rejection</span> - Show All
@endsection
@section('content')
<div class="panel panel-flat">
{{ Form::open(array('url' => route('shipmentrejection.index'), 'method' => 'GET', 'id' => 'date_form')) }}
    ...
    <table class="table datatable-pagination">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{ route('shipmentrejection.show', $data->id) }}">
                    {{ $data->shipment_id }}
                    </a>
                </td>
                <td>
                ...
                <td>
                    ...
                    Rejected
                    @elseif(($data->id_shipment_status > 0))
                    Active
                    @endif
                </td>
            </tr>
