...
@section('title')
    Show Shipment Rejection
@endsection
@section('page_title')
<span class="text-semibold">Shipment Rejection</span> - Show
@endsection
@section('content')
    ...
    <div class="row">
        ...
        <div class="alert alert-danger no-border">
         ...
         @endif
        <div class="col-md-12">
            {{ Form::open(array('url' => route('shipmentrejection.update', $data->id), 'method' => 'PUT')) }}
                <div class="panel panel-flat">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="rejection_type" value="1" @if($data->rejection_type == "1") checked @endif>
                                Dangerous Goods
                            </label>
                        </div>
                        ...
                        <div class="text-right form-group">
                            <button type="submit" class="btn btn-danger" @if($data->id_shipment_status < 0) disabled @endif><i class="icon-trash position-left"></i>Rejection</button>
                        </div>
                    </div>
                </div>
            {{ Form::close() }}
