...
class ShipmentMatchingMonitorAdminController extends Controller
{
    /**
    ...
    */
    public function index()
    {
        ...
        if (Input::get('param') == 'blank' || !Input::get('param') ) {
            $data['datas'] = Shipment::all();
        } else {
            $data['param'] = Input::get('param');
            $data['value'] = Input::get('value');
            $data['datas'] = Shipment::where([Input::get('param') => Input::get('value')]);
        }

        if (Input::get('match')) {
            $data['match'] = Input::get('match');
            if ($data['match'] != 'all') {
                $data['datas'] = $data['datas']->where('registration_type', Input::get('match'));
            }
        ...
        foreach($data['datas'] as $dat) {
            ...
            $data['slot_id'] = $dat->id_slot ? SlotList::find($dat->id_slot) : null;
        }
        return view('admin.shipmentmatchingmonitors.index', $data);
    }
    ...
    */
    public function create()
    {
        ...
        return view('admin.shipmentmatchingmonitors.create', $data);
    }
