...
Route::post('/member_list', 'API\\UserController@getUserByStoreToken');
...
Route::get('/pushnotif/confirmation/15before/', 'API\\PushNotifier@_1');
Route::get('/pushnotif/pickup/15before/', 'API\\PushNotifier@_2');
